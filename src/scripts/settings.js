  ...
  addCustomWebsite: function () {
    ...
    '<label>' +
      ...
      '<select class="custom-website-app">' +
        '<option value="Axosoft">Axosoft</option>' +
        '<option value="AnyDo">Any.do</option>' +
        '<option value="Asana">Asana</option>' +
        '<option value="BamBam">BamBam</option>' +
        ...
        '<option value="GoogleMail">Google Mail</option>' +
        '<option value="GQueue">GQueue</option>' +
        '<option value="HabitRPG">Habit RPG</option>' +
